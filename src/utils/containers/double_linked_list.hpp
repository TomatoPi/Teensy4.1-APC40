...
public:
    ...
    // struct iterator
    // {
    //     double_linked_node* anchor_ptr;
    //     double_linked_node* current_ptr;
    ...
    //     iterator& operator++ ()
    //         { return current_ptr = current_ptr->_next; }

    //     double_linked_node& operator* ()
    //         { return *current_ptr; }
        
    //     const double_linked_node& operator* () const
    //         { return *current_ptr; }
    // };
